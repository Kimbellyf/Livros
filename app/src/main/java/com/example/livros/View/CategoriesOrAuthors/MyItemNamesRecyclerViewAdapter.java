...
import com.example.livros.View.CategoriesOrAuthors.ItemNamesFragment.OnListFragmentInteractionListener;
...
public class MyItemNamesRecyclerViewAdapter extends RecyclerView.Adapter<MyItemNamesRecyclerViewAdapter.ViewHolder> {
    ...
    public MyItemNamesRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
